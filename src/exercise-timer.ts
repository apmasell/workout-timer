...
const programmes: ProgrammeMenu = {
  ...
  "Foot Strength": [
    { type: "work", name: "Massage between metatasals", link: "https://www.youtube.com/watch?v=MHqMLLjmDPI" },
    { type: "rest", time: 10 },
    {
      type: "superset",
      repeat: 3,
      activities: [
        { type: "rest", time: 10 },
        { type: "work", time: 20, name: "Proneal Stretch (Hold; Left)" },
        { type: "rest", time: 10 },
        { type: "work", time: 20, name: "Proneal Stretch (Hold; Right)" },
      ],
    },
    {
      type: "superset",
      ...
      activities: [
        { type: "rest", time: 10 },
        { type: "work", time: 40, name: "Forced arch (Hold)" },
      ],
    },
    {
      type: "superset",
      ...
      activities: [
        { type: "rest", time: 10 },
        { type: "work", time: 20, name: "Standing Inversion (Roll onto edges; Toes lift; Reps)" },
        { type: "rest", time: 10 },
        { type: "work", time: 20, name: "Standing Supination (Left; Hand on Support)" },
        { type: "rest", time: 10 },
        { type: "work", time: 20, name: "Standing Supination (Right; Hand on Support)" },
      ],
    },
    { type: "rest", time: 10 },
    { type: "work", name: "Side Pull (Banded; 12)" },
    { type: "rest", time: 10 },
