...
const programmes: ProgrammeMenu = {
  ...
  "Foot Strength": [
    {
      type: "work",
      name: "Massage between metatasals",
      link: "https://www.youtube.com/watch?v=MHqMLLjmDPI",
    },
    { type: "rest", time: 10 },
    {
      type: "superset",
      repeat: 4,
      activities: [
        { type: "work", time: 60, name: "Forced arch (Hold)" },
        { type: "rest", time: 10 },
      ],
    },
    {
      ...
      activities: [
        {
          type: "work",
          time: 15,
          name: "RAIL/PAIL (Left; Press)",
        },
        {
          type: "work",
          time: 15,
          name: "RAIL/PAIL (Left; Lift)",
        },
        { type: "rest", time: 20 },
        {
          type: "work",
          time: 15,
          name: "RAIL/PAIL (Right; Press)",
        },
        {
          type: "work",
          time: 15,
          name: "RAIL/PAIL (Right; Lift)",
        },
        { type: "rest", time: 20 },
      ],
    },
