...
const allProgrammes: ProgrammeMenu = {
  "Warm-up": {
    Upper: [
      ...
      { type: "rest", time: 15 },
      { type: "work", name: "Dead Hang (Pronated)", time: 10 },
      { type: "rest", time: 5 },
      { type: "work", name: "Dead Hang (Supinated)", time: 10 },
      { type: "work", name: "Wrist Curls (15-20)" },
      { type: "work", name: "Halos (25lbs; 10)" },
      { type: "work", name: "Wrist Curls (15-20)" },
      { type: "work", name: "Bar Tricep Massage & Bar Pulls" },
      { type: "work", name: "Wrist Curls (15-20)" },
      { type: "work", name: "Train Tracks" },
    ],
    Lower: [
      { type: "work", name: "Massage feet" },
      { type: "work", name: "Leaning Back Hamstring stretch", time: 30 },
      { type: "rest", time: 15 },
    ...
    "1 Cole 3 (Shoulders & Arms)": [
...

      {
        ...
        activities: [
          {
            type: "work",
            name: "Lateral Raise (Seated; DB; Neutral; 10-12; 3-0-1-0)",
          },
          { type: "rest", time: 60 },
        ],
      },
    ...
    "5.1": [
      {
        ...
        repeat: 4,
        activities: [
          { type: "work", name: "Overhead Squat (BB; 6; 2-0-X-2)" },
          { type: "rest", time: 90 },
        ],
      },
      {
        ...
        activities: [
          {
            type: "work",
            name: "Push Press (Snatch Grip; 10; 2-1-X-1)",
            link: "https://youtu.be/KD-9_XjGLfI?si=gZMTD1EZoieEiW8M",
          },
          { type: "rest", time: 60 },
        ],
      },
      {
        ...
        repeat: 3,
        activities: [
          { type: "work", name: "Front Squat (1¼; 4-6)" },
          { type: "rest", time: 90 },
        ],
      },
      {
    ...
    "5.2": [
      {
        ...
        activities: [
          {
            type: "work",
            name: "RDL/Row Combo (6)",
            link: "https://youtu.be/Id-149o2Mew",
          },
          { type: "rest", time: 60 },
          {
            type: "work",
            name: "Chinese DB Laterals (12; 3-0-3-0)",
            link: "https://youtu.be/kZz5VQ8B4Ao?si=VcOizWzBDH5lnaRt",
          },
          { type: "rest", time: 60 },
        ],
      },
      {
        ...
        repeat: 3,
        activities: [
          { type: "work", name: "Pushup (DB; 10; 3-0-1-0)" },
          { type: "rest", time: 60 },
          {
            type: "work",
            name: "Row (Scapular Focused; Segmented; 8)",
      ...
      },
      {
        ...
        repeat: 3,
        activities: [
          { type: "work", name: "Scapular Pull Ups (AMRAP)" },
          { type: "rest", time: 45 },
          {
            type: "work",
            name: "External Rotation and Press (Half-Kneeling; 6)",
            link: "https://youtu.be/kZz5VQ8B4Ao?si=VcOizWzBDH5lnaRt",
          },
          { type: "rest", time: 45 },
        ],
    ...
    "5.3": [
      {
        ...
        repeat: 4,
        activities: [
          { type: "work", name: "Squat (Overhead; BB; Paused; 5; 2-2-X-2)" },
          { type: "rest", time: 90 },
        ],
      },
      {
        ...
        repeat: 3,
        activities: [
          { type: "work", name: "DB OHP (Seated; Unsupported; 12; 3-0-X-0)" },
          { type: "rest", time: 60 },
        ],
      },

      {
        ...
        repeat: 3,
        activities: [
          { type: "work", name: "BB RDL (Heavy; 4-6; 2-0-X-1)" },
          { type: "rest", time: 90 },
        ],
      },
      {
        ...
        repeat: 4,
        activities: [
          { type: "work", name: "Side Plank with Rotation (AMRAP)" },
          { type: "rest", time: 60 },
        ],
      },
    ],
    "5.4": [
      {
        ...
        repeat: 4,
        activities: [
          { type: "work", name: "RDL/Row Combo (6)" },
          { type: "rest", time: 60 },
          { type: "work", name: "Flat DB Press (12; 3-0-X-0)" },
          { type: "rest", time: 60 },
        ],
      },

      {
        ...
        activities: [
          {
            type: "work",
            name: "Reverse Lunge (Slider; Long Lever; 10; 3-0-1-0)",
            link: "https://youtu.be/aRpXyDlUlIE?si=OV9cYvwnF9GTPY0m",
          },
          { type: "rest", time: 60 },
          {
            type: "work",
      ...
      },
      {
        ...
        repeat: 3,
        activities: [
          { type: "work", name: "Scapular Chins (AMRAP)" },
          { type: "rest", time: 45 },
          {
            type: "work",
            name: "Banded Y Raise (12-15)",
            link: "https://youtube.com/shorts/a_Ot3Tk4mRA?si=HQ5suQB67oBBCJr8",
          },
          { type: "rest", time: 45 },
        ],
      },
  ...
  Intensification: {
    ...
    "3 Cole (Day 1)": [
      ...[5, 4, 3, 2, 1, 1].flatMap<RootExcercise>((i) => [
        { type: "work", name: `Squat (${i}; 3-2-X-0)` },
        { type: "rest", time: 180 },
      ]),
      {
        type: "superset",
      ...
      },
      {
        ...
        activities: [
          {
            type: "work",
            name: "Back Extension (Wide Grip; Barbell; 6-8; 3-1-X-1) ",
          },
          { type: "rest", time: 120 },
        ],
      },
      {
        ...
        activities: [
          {
            type: "work",
            name: "Trap 3 Raise (25° Incline; Prone; Neutral; 6-8; 3-1-1-1)",
          },
          { type: "rest", time: 60 },
        ],
      },
